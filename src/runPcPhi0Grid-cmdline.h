...
#ifndef RUNPCPHI0GRID_CMDLINE_H
#define RUNPCPHI0GRID_CMDLINE_H
...
#define CMDLINE_PARSER_PACKAGE "runPcPhi0Grid"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "runPcPhi0Grid"
#endif
...
struct gengetopt_args_info
{
  ...
  char * conf_file_arg;	/**< @brief Configuration file to read (default='pcPhi0Grid.conf').  */
  ...
  double phi0_low_arg;	/**< @brief Smallest phi0 (default='-0.004').  */
  char * phi0_low_orig;	/**< @brief Smallest phi0 original value given at command line.  */
  const char *phi0_low_help; /**< @brief Smallest phi0 help description.  */
  double phi0_high_arg;	/**< @brief Largest phi0 (default='0.004').  */
  char * phi0_high_orig;	/**< @brief Largest phi0 original value given at command line.  */
  const char *phi0_high_help; /**< @brief Largest phi0 help description.  */
  int n_phi0_arg;	/**< @brief Number of phi0 in grid (linearly spaced) (default='8').  */
  char * n_phi0_orig;	/**< @brief Number of phi0 in grid (linearly spaced) original value given at command line.  */
  const char *n_phi0_help; /**< @brief Number of phi0 in grid (linearly spaced) help description.  */
  ...
  char * out_arg;	/**< @brief The file name to output the multiple model summary (default='phi0-grid-summary.dat').  */
  ...
  unsigned int phi0_low_given ;	/**< @brief Whether phi0-low was given.  */
  unsigned int phi0_high_given ;	/**< @brief Whether phi0-high was given.  */
  unsigned int n_phi0_given ;	/**< @brief Whether n-phi0 was given.  */
