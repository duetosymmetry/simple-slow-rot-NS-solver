/*
  ...
  gengetopt --file-name=runPhi0Family-cmdline -C
...
const char *gengetopt_args_info_usage = "Usage: runPhi0Family [OPTION]...";

const char *gengetopt_args_info_versiontext = "";

const char *gengetopt_args_info_description = "Run a family of models at fixed phi0";

const char *gengetopt_args_info_help[] = {
  "  -h, --help              Print help and exit",
  "  -V, --version           Print version and exit",
  "\nConfiguration file:",
  "  -C, --conf-file=STRING  Configuration file to read\n                            (default=`phi0Family.conf')",
  ...
  "      --phi0=DOUBLE       Asymptotic scalar phi_0 (dimensionless)\n                            (default=`0.0043')",
  ...
  "  -b, --beta=DOUBLE       alpha_0 (dimensionless)  (default=`-4.5')",
  "\nEquation of state:",
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->conf_file_arg = gengetopt_strdup ("phi0Family.conf");
  ...
  args_info->n_p_arg = 16;
  args_info->n_p_orig = NULL;
  args_info->phi0_arg = 0.0043;
  args_info->phi0_orig = NULL;
  ...
  args_info->out_arg = gengetopt_strdup ("phi0-family-summary.dat");
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->phi0_help = gengetopt_args_info_help[8] ;
  args_info->phic_low_help = gengetopt_args_info_help[9] ;
  args_info->phic_high_help = gengetopt_args_info_help[10] ;
  args_info->alpha_help = gengetopt_args_info_help[13] ;
  args_info->beta_help = gengetopt_args_info_help[14] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->phi0_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->phi0_given)
    write_into_file(outfile, "phi0", args_info->phi0_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->phi0_given)
    {
      fprintf (stderr, "%s: '--phi0' option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
      ...
      switch (c)
        ...
        case 'C':	/* Configuration file to read.  */
          ...
          if (update_arg( (void *)&(args_info->conf_file_arg), 
              ...
              &(local_args_info.conf_file_given), optarg, 0, "phi0Family.conf", ARG_STRING,
        ...
        case 'b':	/* alpha_0 (dimensionless).  */
          ...
          if (update_arg( (void *)&(args_info->beta_arg), 
              ...
              &(local_args_info.beta_given), optarg, 0, "-4.5", ARG_DOUBLE,
              check_ambiguity, override, 0, 0,
              "beta", 'b',
              additional_error))
            goto failure;
        ...
        case 'o':	/* The file name to output the multiple model summary.  */
          ...
          if (update_arg( (void *)&(args_info->out_arg), 
              ...
              &(local_args_info.out_given), optarg, 0, "phi0-family-summary.dat", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "out", 'o',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          else if (strcmp (long_options[option_index].name, "n-p") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->n_p_arg), 
                ...
                &(local_args_info.n_p_given), optarg, 0, "16", ARG_INT,
                check_ambiguity, override, 0, 0,
                "n-p", '-',
                additional_error))
              goto failure;
          ...
          /* Asymptotic scalar phi_0 (dimensionless).  */
          else if (strcmp (long_options[option_index].name, "phi0") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->phi0_arg), 
                 &(args_info->phi0_orig), &(args_info->phi0_given),
                &(local_args_info.phi0_given), optarg, 0, "0.0043", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "phi0", '-',
                additional_error))
              goto failure;
