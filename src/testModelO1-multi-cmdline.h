/** @file testModelO1-multi-cmdline.h
...
#ifndef TESTMODELO1_MULTI_CMDLINE_H
#define TESTMODELO1_MULTI_CMDLINE_H
...
#define CMDLINE_PARSER_PACKAGE "testModelO1-multi"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "testModelO1-multi"
#endif
...
struct gengetopt_args_info
{
  ...
  char * conf_file_arg;	/**< @brief Configuration file to read (default='modelO1-multi.conf').  */
  ...
  char * out_arg;	/**< @brief The file name to output the multiple model summary (default='summary1.dat').  */
...
#endif /* __cplusplus */
#endif /* TESTMODELO1_MULTI_CMDLINE_H */
