/** @file testModelO1-single-cmdline.h
...
#ifndef TESTMODELO1_SINGLE_CMDLINE_H
#define TESTMODELO1_SINGLE_CMDLINE_H
...
#define CMDLINE_PARSER_PACKAGE "testModelO1-single"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "testModelO1-single"
#endif
...
struct gengetopt_args_info
{
  ...
  char * conf_file_arg;	/**< @brief Configuration file to read (default='modelO1.conf').  */
  ...
  double pc_arg;	/**< @brief Central pressure in dyne/cm^2 (default='4.039e+34').  */
  char * pc_orig;	/**< @brief Central pressure in dyne/cm^2 original value given at command line.  */
  const char *pc_help; /**< @brief Central pressure in dyne/cm^2 help description.  */
  ...
  char * out_0_arg;	/**< @brief The file name to output the background model (default='background.dat').  */
  char * out_0_orig;	/**< @brief The file name to output the background model original value given at command line.  */
  const char *out_0_help; /**< @brief The file name to output the background model help description.  */
  char * out_1_arg;	/**< @brief The file name to output the O(a^1) model (default='O1.dat').  */
  char * out_1_orig;	/**< @brief The file name to output the O(a^1) model original value given at command line.  */
  const char *out_1_help; /**< @brief The file name to output the O(a^1) model help description.  */
  
  unsigned int help_given ;	/**< @brief Whether help was given.  */
  unsigned int version_given ;	/**< @brief Whether version was given.  */
  unsigned int conf_file_given ;	/**< @brief Whether conf-file was given.  */
  unsigned int pc_given ;	/**< @brief Whether pc was given.  */
  ...
  unsigned int out_0_given ;	/**< @brief Whether out-0 was given.  */
  unsigned int out_1_given ;	/**< @brief Whether out-1 was given.  */
...
#endif /* __cplusplus */
#endif /* TESTMODELO1_SINGLE_CMDLINE_H */
