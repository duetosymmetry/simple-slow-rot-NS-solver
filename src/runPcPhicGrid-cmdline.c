/*
  ...
  gengetopt --file-name=runPcPhicGrid-cmdline -C
...
const char *gengetopt_args_info_usage = "Usage: runPcPhicGrid [OPTION]...";

const char *gengetopt_args_info_versiontext = "";

const char *gengetopt_args_info_description = "Run a grid of models with grid spacing in pc, phic";

const char *gengetopt_args_info_help[] = {
  "  -h, --help              Print help and exit",
  "  -V, --version           Print version and exit",
  "\nConfiguration file:",
  "  -C, --conf-file=STRING  Configuration file to read\n                            (default=`pcPhicGrid.conf')",
  ...
  "      --phic-low=DOUBLE   Smallest central phi  (default=`-0.004')",
  "      --phic-high=DOUBLE  Largest  central phi  (default=`0.004')",
  "      --n-phi=INT         Number of phic in grid (linearly spaced)\n                            (default=`8')",
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->conf_file_arg = gengetopt_strdup ("pcPhicGrid.conf");
  ...
  args_info->phic_low_arg = -0.004;
  args_info->phic_low_orig = NULL;
  args_info->phic_high_arg = 0.004;
  args_info->phic_high_orig = NULL;
  args_info->n_phi_arg = 8;
  args_info->n_phi_orig = NULL;
  ...
  args_info->out_arg = gengetopt_strdup ("grid-summary.dat");
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->phic_low_help = gengetopt_args_info_help[8] ;
  args_info->phic_high_help = gengetopt_args_info_help[9] ;
  args_info->n_phi_help = gengetopt_args_info_help[10] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->n_phi_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->n_phi_given)
    write_into_file(outfile, "n-phi", args_info->n_phi_orig, 0);
      ...
      switch (c)
        ...
        case 'C':	/* Configuration file to read.  */
          ...
          if (update_arg( (void *)&(args_info->conf_file_arg), 
              ...
              &(local_args_info.conf_file_given), optarg, 0, "pcPhicGrid.conf", ARG_STRING,
        ...
        case 'o':	/* The file name to output the multiple model summary.  */
          ...
          if (update_arg( (void *)&(args_info->out_arg), 
              ...
              &(local_args_info.out_given), optarg, 0, "grid-summary.dat", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "out", 'o',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          else if (strcmp (long_options[option_index].name, "phic-low") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->phic_low_arg), 
                ...
                &(local_args_info.phic_low_given), optarg, 0, "-0.004", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "phic-low", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "phic-high") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->phic_high_arg), 
                ...
                &(local_args_info.phic_high_given), optarg, 0, "0.004", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "phic-high", '-',
                additional_error))
              goto failure;
          ...
          /* Number of phic in grid (linearly spaced).  */
          else if (strcmp (long_options[option_index].name, "n-phi") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->n_phi_arg), 
                 &(args_info->n_phi_orig), &(args_info->n_phi_given),
                &(local_args_info.n_phi_given), optarg, 0, "8", ARG_INT,
                check_ambiguity, override, 0, 0,
                "n-phi", '-',
                additional_error))
              goto failure;
