/*
  ...
  gengetopt --file-name=testPhi0Solver-cmdline -C
...
const char *gengetopt_args_info_usage = "Usage: testPhi0Solver [OPTION]...";

const char *gengetopt_args_info_versiontext = "";

const char *gengetopt_args_info_description = "Find a stellar model's params with given phi0";
...
const char *gengetopt_args_info_help[] = {
  ...
  "\nFile output:",
  "  -o, --out=STRING        The file name to output the model\n                            (default=`background.dat')",
    0
};
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->out_arg = gengetopt_strdup ("background.dat");
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->pc_help = gengetopt_args_info_help[3] ;
  args_info->phi0_help = gengetopt_args_info_help[4] ;
  args_info->phic_low_help = gengetopt_args_info_help[5] ;
  args_info->phic_high_help = gengetopt_args_info_help[6] ;
  args_info->alpha_help = gengetopt_args_info_help[9] ;
  args_info->beta_help = gengetopt_args_info_help[10] ;
  args_info->eos_name_help = gengetopt_args_info_help[13] ;
  args_info->log10p1_help = gengetopt_args_info_help[15] ;
  args_info->Gamma1_help = gengetopt_args_info_help[16] ;
  args_info->Gamma2_help = gengetopt_args_info_help[17] ;
  args_info->Gamma3_help = gengetopt_args_info_help[18] ;
  args_info->out_help = gengetopt_args_info_help[20] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVp:a:b:o:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'b':	/* alpha_0 (dimensionless).  */
          ...
          break;
        case 'o':	/* The file name to output the model.  */
        
        
          if (update_arg( (void *)&(args_info->out_arg), 
               &(args_info->out_orig), &(args_info->out_given),
              &(local_args_info.out_given), optarg, 0, "background.dat", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "out", 'o',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "phi0") == 0)
          {
