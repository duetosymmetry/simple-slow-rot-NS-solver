/*
  ...
  gengetopt --file-name=backgroundModelTest-cmdline -C
...
const char *gengetopt_args_info_usage = "Usage: backgroundModelTest [OPTION]...";

const char *gengetopt_args_info_versiontext = "";

const char *gengetopt_args_info_description = "Run a single background stellar model";
...
const char *gengetopt_args_info_help[] = {
  ...
  "      --phic=DOUBLE      Central scalar phi (dimensionless)  (default=`0.0043')",
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->phic_arg = 0.0043;
  args_info->phic_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->phic_help = gengetopt_args_info_help[4] ;
  args_info->alpha_help = gengetopt_args_info_help[7] ;
  args_info->beta_help = gengetopt_args_info_help[8] ;
  args_info->eos_name_help = gengetopt_args_info_help[11] ;
  args_info->log10p1_help = gengetopt_args_info_help[13] ;
  args_info->Gamma1_help = gengetopt_args_info_help[14] ;
  args_info->Gamma2_help = gengetopt_args_info_help[15] ;
  args_info->Gamma3_help = gengetopt_args_info_help[16] ;
  args_info->out_help = gengetopt_args_info_help[18] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->phic_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->phic_given)
    write_into_file(outfile, "phic", args_info->phic_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->phic_given)
    {
      fprintf (stderr, "%s: '--phic' option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          /* Central scalar phi (dimensionless).  */
          if (strcmp (long_options[option_index].name, "phic") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->phic_arg), 
                 &(args_info->phic_orig), &(args_info->phic_given),
                &(local_args_info.phic_given), optarg, 0, "0.0043", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "phic", '-',
                additional_error))
              goto failure;
