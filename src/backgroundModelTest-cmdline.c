...
const char *gengetopt_args_info_usage = "Usage: backgroundModelTest [OPTIONS]...";
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->eos_name_help = gengetopt_args_info_help[6] ;
  args_info->log10p1_help = gengetopt_args_info_help[8] ;
  args_info->Gamma1_help = gengetopt_args_info_help[9] ;
  args_info->Gamma2_help = gengetopt_args_info_help[10] ;
  args_info->Gamma3_help = gengetopt_args_info_help[11] ;
  args_info->out_help = gengetopt_args_info_help[13] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVp:o:", long_options, &option_index);
